...
private extension ViewController {
    func setupCalendar() {
        ...
        calendar.appearance.font.weekdayHeader = UIFont.systemFont(ofSize: 9, weight: .bold)
        calendar.appearance.font.days = UIFont.systemFont(ofSize: 12, weight: .bold)
        calendar.appearance.font.topRight = UIFont.systemFont(ofSize: 8, weight: .regular)
        calendar.appearance.size.circleRadius = 10
    }
}
